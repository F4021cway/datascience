-- ASSIGNMENT 1 FOR SQL SESSIONS, F4021-ALP
...
SELECT city, COUNT(customer_id) as city_number
FROM sale.customer
GROUP BY city
...
SELECT COUNT(quantity) as total_product_quantity, order_id
...
select quantity from sale.order_item,
	SUM(quantity)
